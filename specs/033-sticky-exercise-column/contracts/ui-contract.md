...
6. A subtle divider using the existing border colour marks the fixed column's trailing edge.
7. No horizontal divider appears between the header row and first body row.
8. No shadow, divider, or fixed surface may obscure the exercise text itself.
