...
3. Add explicit layering so scrolling statistics disappear behind the fixed column; omit a trailing vertical divider and remove the header-cell bottom border while retaining body-row dividers.
